---
title: Order an Amazon wish list by price drop percentage
---

This is quite specific, silly and potentially broken, but I needed a way to order my Amazon wish list of books. You might think Amazon has got this covered with their sorting functionality – however, it is completely broken when you have a list that is several pages long. Since they use infinite scrolling, their sorting actually only works on each page separately and not for the full list. So this little script reorders the full list (provided it is loaded first).
